...
``typed_env`` -- Object-Oriented OS Environment
-----------------------------------------------
...
``typed_dict`` -- Dictionaries with type-annotated accessors
------------------------------------------------------------
...
``typed_str`` -- Adding typed accessors to parts of strings
-----------------------------------------------------------
